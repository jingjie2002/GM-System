# Generated by Django 6.0 on 2025-12-28 03:39
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item_id",
                    models.IntegerField(
                        default=1, help_text="1=金币, 2=钻石", verbose_name="道具ID"
                    ),
                ),
                (
                    "item_count",
                    models.PositiveIntegerField(default=100, verbose_name="道具数量"),
                ),
                (
                    "max_uses",
                    models.PositiveIntegerField(
                        default=1, help_text="最多可被兑换次数", verbose_name="总额度"
                    ),
                ),
                (
                    "used_count",
